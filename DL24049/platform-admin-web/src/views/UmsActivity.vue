<template>
    ...
    <el-table :data="tableData" border  style="width: 100%">
      ...
      <el-table-column fixed="right" label="操作" width="300px">
        <template #default="scope">
          <el-button type="success" size="small" @click="viewApply(scope.row)">查看报名详情</el-button>
  ...
  <el-dialog  v-model="dialogApplyFormVisible" :title="formTitle">
    <el-table :data="applyTableData" border  style="width: 100%">
      <el-table-column prop="nickname" label="游客名称"  />
...
<script setup>
import { pageUmsActivity, addUmsActivity, modifyUmsActivity, deleteUmsActivity } from '@/api/umsActivity'
import { onMounted, reactive, ref } from 'vue'
import { ElMessage, ElMessageBox } from 'element-plus'
import { getAllUmsPlaces } from '@/api/umsPlaces'
import { getAllUmsActivityApply } from '@/api/umsActivityApply'
...
const dialogApplyFormVisible = ref(null)
const applyTableData = ref(null)
...
const viewApply = (row) => {
  dialogApplyFormVisible.value = true
  getAllUmsActivityApply(row.id, data => {
