<template>
  ...
  <el-dialog  v-model="dialogFormVisible" :title="formTitle">
    <el-form :model="form" :rules="formRules" ref="formRef">
       ...
       <el-form-item label="关键词：" :label-width="formLabelWidth" prop="keyWord">
...
<script setup>
import { pageUmsPlaces, addUmsPlaces, modifyUmsPlaces, deleteUmsPlaces } from '@/api/umsPlaces'
...
const handleSubmit = () => {
  formRef.value.validate(valid => {
    ...
    if (form.actionType === 'add') {
      promise = addUmsPlaces(form)
    } else {
      promise = modifyUmsPlaces(form.id, form)
    }
